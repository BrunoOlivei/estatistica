...
**Exemplo**: Consideramos um experimento aleatório e os eventos A e B associados, tais que P(A)  = 1/2, P(B) = 1/3 e P(A $\cap$ B) = 1/4:
...
**Exemplo**: Num lote com 20 peças existam cinco defeituosas. Escolhemos quatro peças do lote ao acaso:
